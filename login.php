...
<body>
  ...
  <div class="container-fluid">
    <h2 class="navbar-brand" href="index.php">Website Galeri Foto</h2>
		...
		<div class="col-md-4">
			<div class="card">
				<div class="card-body bg-lign">
					...
					<hr>
					<p>Belum Punya akun? <a href="register.php">Login Disisni!</a></p>
				</div>
			</div>
		</div>
	</div>
...
<footer class="d-flex justify-content-center border-top mt-2 bg-secondary fixed-bottom">
        <p class="pt-2 text-light">&copy; UKK RPL 2024 | Naisyela Amelia Putri</p>
    </footer>
